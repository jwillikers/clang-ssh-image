...
buildah run "$CONTAINER" /bin/sh -c 'microdnf install -y clang clang-tools-extra cmake libcxx-devel libcxxabi-devel lld lldb ninja-build python3 python3-pip python3-wheel python-unversioned-command --nodocs --setopt install_weak_deps=0'
